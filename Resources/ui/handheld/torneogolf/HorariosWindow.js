function HorariosWindow(Window) {
	...
	var torneoHorarioWdw = Titanium.UI.createWindow({
		tabBarHidden : true,
	...
	var createAttachChWindow = function() {
		...
		torneoHorarioWdw.add(imageViewBar);

		torneoHorarioWdw.add(scrollView_1);
	...
	buttonClose.addEventListener('click', function(e) {
		Ti.Media.vibrate();
		torneoHorarioWdw.close();
	});

	torneoHorarioWdw.addEventListener('android:back', function(e) {
		Ti.Media.vibrate();
		torneoHorarioWdw.close();
	});

	return torneoHorarioWdw;
}
