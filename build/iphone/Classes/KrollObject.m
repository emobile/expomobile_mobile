...
//@interface ExpomobileObject : NSObject
//@end

@interface ExpomobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ExpomobileObject class]])
		{
			for (NSString *key in [[(ExpomobileObject*)o modules] allKeys])
			{
