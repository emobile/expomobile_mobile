...
/**
 Base class for all Expomobile views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Expomobile view hierarchy (such as wrapped iOS UIViews) was touched.
