...
// in simulator we redefine to format for Expomobile Developer console
...
{\
	NSString * exceptionName = [@"org.expomobile." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.expomobile";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIExpomobileNativeItemNone = -1, 
	UIExpomobileNativeItemSpinner = -2,
	UIExpomobileNativeItemProgressBar = -3,
	
	UIExpomobileNativeItemSlider = -4,
	UIExpomobileNativeItemSwitch = -5,
	UIExpomobileNativeItemMultiButton = -6,
	UIExpomobileNativeItemSegmented = -7,
	
	UIExpomobileNativeItemTextView = -8,
	UIExpomobileNativeItemTextField = -9,
	UIExpomobileNativeItemSearchBar = -10,
	
	UIExpomobileNativeItemPicker = -11,
	UIExpomobileNativeItemDatePicker = -12,
	
	UIExpomobileNativeItemInfoLight = -13,
	UIExpomobileNativeItemInfoDark = -14,
	
	UIExpomobileNativeItemDisclosure = -15,
	
	UIExpomobileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Expomobile instances of
