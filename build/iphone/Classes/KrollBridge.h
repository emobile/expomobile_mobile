...
@interface ExpomobileObject : KrollCoverageObject {
#else
@interface ExpomobileObject : KrollObject {
#endif
@private
...
extern NSString * Expomobile$ModuleRequireFormat;
